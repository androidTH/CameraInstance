...
public class Camera2Activity extends BaseCameraActivity implements ActivityCompat.OnRequestPermissionsResultCallback{
    ...
    private final TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture texture, int width, int height) {
            Log.i("TextureView","宽="+width+"高="+height);
                    ...
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            ...
                            try {
                                ...
                                setAutoFlash(mPreviewRequestBuilder);//设置闪光灯
    ...
    private void configureTransform(int viewWidth, int viewHeight) {
        ...
        Log.i("configureTransform","控件的宽"+viewWidth+"高="+viewHeight+"surface旋转角度="+rotation+"预览的高和宽"+mPreviewSize.getWidth()+"*"+mPreviewSize.getHeight());
