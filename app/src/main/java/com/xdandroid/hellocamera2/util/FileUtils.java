...
public class FileUtils {
     ...
     * 保存Image的目录名
     */
    private final static String FOLDER_NAME = "/wallet";
    ...
    public static String makeAppDir() {
    ...
    public static String getRecorderDirectory(Context context){
        ...
        if(isSDCardMounted()) {
            ...
            appCacheDir = new File(dcimPath + "/Camera/idcardImage");
        ...
        if(appCacheDir == null) {
            String cacheDirPath = "/data/data/" + context.getPackageName() + "/idcardImage/";
     ...
     * @param targeFilePath
     */
    public static void copy(String sourceFilePath, String targeFilePath) {
        ...
        try {
            ...
            fo = new FileOutputStream(targeFilePath);
